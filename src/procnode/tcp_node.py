...
class TCPNode(Node):
    ...
    '''
    def connectTCP(self, id, host, port):                                       #Done: add code to connect to a remote TCPNode at host:port.
        if self.server == None:
            try:
    ...
    '''
    def duplexify(self, id):                                                    #Done: All tcp conns are duplexes, so check if id is a tcp node.
    ...
    '''
    def disconnect(self, id, notify = True):                                    #Done: If id is a tcp node, disconnect in your own way. else, call super version.
    ...
    '''
    def update(self):                                                           #Done: Implement for super version and tcp nodes.
        super().update()
    ...
    '''
    def send(self, id, msg):                                                    #Done: Implement for super version and tcp nodes.
    ...
    '''
    def recv(self, block = True):                                               #Done: Implement for super version and tcp nodes.
        super()._checkNodeOn()
        if block:
            self.update()
            # if self.tcpOn:
