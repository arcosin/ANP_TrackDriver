...
class ValueNetwork(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, saved_v_net=None):
        ...
        if saved_v_net != None:
            self.load_state_dict(saved_v_net)
...
class SoftQNetwork(nn.Module):
    ...
    def __init__(self, num_inputs, num_actions, hidden_size=256, saved_q_net=None):
        ...
        if saved_q_net != None:
            self.load_state_dict(saved_q_net)
...
class PolicyNetwork(nn.Module):
    ...
    def __init__(self, num_inputs, num_actions, hidden_size=256, log_std_min=-20, log_std_max=2, saved_pi_net=None):
        ...
        if saved_pi_net != None:
            self.load_state_dict(saved_pi_net)
